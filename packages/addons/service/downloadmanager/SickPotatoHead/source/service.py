...
__start__      = xbmc.translatePath( os.path.join( __cwd__, 'resources/data/bin', "SickPotatoHead.py") )
__stop__       = xbmc.translatePath( os.path.join( __cwd__, 'resources/data/bin', "SickPotatoHead.stop") )
